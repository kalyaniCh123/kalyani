...
public class validandInvalid {
	...
	public static void main(String[] args)
	{
				...
				driver.findElement(ById.name("txtUsername")).sendKeys("Admin");
				driver.findElement(ById.id("txtPassword")).sendKeys("admin123");
				driver.findElement(ById.id("btnLogin")).click();
